...
public class HookDef extends ConstantDefiner<HookDef.Hook> {
    ...
    public static final Hook BATCHED_MEDIA_LIMITER = new Hook("BATCHED_MEDIA_LIMITER", HookClassDef.SENT_VIDEO, "bi", new Object[0]);
    ...
    public static final Hook CHAT_METADATA_WRITE_SECOND = new Hook("CHAT_METADATA_WRITE_SECOND", HookClassDef.CHAT_METADATA_JSON_PARSER_SECOND, "a", "com.google.gson.stream.JsonWriter", "atjr");
    public static final Hook CHAT_NOTIFICATION = new Hook("CHAT_NOTIFICATION", HookClassDef.CHAT_NOTIFICATION_CREATOR, "a", "aohl", "com.snapchat.android.core.notification.model.NotificationProcessorCallback");
    ...
    public static final Hook CHAT_VIDEO_PATH = new Hook("CHAT_VIDEO_PATH", HookClassDef.CHAT_VIDEO, "eX_", new Object[0]);
    public static final Hook CHECK_LENS_ASSET_AUTH = new Hook("CHECK_LENS_ASSET_AUTH", HookClassDef.LENS_AUTHENTICATION, "a", "afwj", String.class);
    ...
    public static final Hook CHECK_LENS_CATEGORY_AUTH = new Hook("CHECK_LENS_CATEGORY_AUTH", HookClassDef.LENS_AUTHENTICATION, "a", "afwd", String.class);
    ...
    public static final Hook DISPATCH_CHAT_UPDATE = new Hook("DISPATCH_CHAT_UPDATE", HookClassDef.NETWORK_DISPATCHER, "a", "aiqx", "asyk");
    ...
    public static final Hook GET_SNAP_ID = new Hook("GET_SNAP_ID", HookClassDef.SNAP_BASE, "h", new Object[0]); // Checked
    ...
    public static final Hook GET_USERNAME = new Hook("GET_USERNAME", HookClassDef.USER_PREFS, "w");
    ...
    public static final Hook GROUP_GET_ALGORITHM = new Hook("GROUP_GET_ALGORITHM", HookClassDef.GROUP_SNAP_METADATA, "a", "aisw");
    ...
    public static final Hook MARK_STORY_VIEWED = new Hook("MARK_STORY_VIEWED", HookClassDef.STORY_STATUS_UPDATER, "a", "ammc", HookClassDef.STORY_SNAP.getStrClass(), Boolean.TYPE);
    ...
    public static final Hook REPLACE_SHARED_IMAGE = new Hook("REPLACE_SHARED_IMAGE", HookClassDef.SHARE_IMAGE, "a", "fjw", Integer.class, String.class, long.class, boolean.class, int.class, "fjv$b");
    public static final Hook REPLACE_SHARED_VIDEO = new Hook("REPLACE_SHARED_VIDEO", HookClassDef.SHARE_VIDEO, "a", Uri.class, Integer.TYPE, Boolean.TYPE, "apmf", Long.TYPE, Long.TYPE);
    ...
    public static final Hook SENT_BATCHED_SNAP = new Hook("SENT_BATCHED_SNAP", HookClassDef.SENT_BATCHED_VIDEO, "c", new Object[0]);
    ...
    public static final Hook SNAP_GET_MEDIA_TYPE = new Hook("SNAP_GET_MEDIA_TYPE", HookClassDef.SNAP_BASE, "aU_", new Object[0]); // Checked
    public static final Hook SNAP_GET_TIMESTAMP = new Hook("SNAP_GET_TIMESTAMP", HookClassDef.STORY_SNAP, "az_", new Object[0]); // Checked
    public static final Hook SNAP_GET_USERNAME = new Hook("SNAP_GET_USERNAME", HookClassDef.RECEIVED_SNAP, "s", new Object[0]); // Checked
    public static final Hook STORY_DISPLAYED = new Hook("STORY_DISPLAYED", HookClassDef.STORY_ADVANCER, "E", new Object[0]);
    public static final Hook STORY_GET_ALGORITHM = new Hook("STORY_GET_ALGORITHM", HookClassDef.STORY_SNAP, "aq", new Object[0]);
    public static final Hook STORY_METADATA_BUILDER = new Hook("STORY_METADATA_BUILDER", HookClassDef.STORY_METADATA_LOADER, "a", HookClassDef.STORY_SNAP.getStrClass(), "aola", "aokz", "amms");
